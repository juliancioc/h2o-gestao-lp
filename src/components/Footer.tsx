        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a target="_blank" href="https://www.instagram.com/h2ogestao/" className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors">
